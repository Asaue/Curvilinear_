...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default=r"./append_\demo", help="test data path")
    ...
    parser.add_argument("--sam_checkpoint", type=str, default=r'workdir\models\sam\cssam_best.pth', help="sam checkpoint")
    parser.add_argument("--boxes_prompt", type=str2bool, default=False, help="use boxes prompt")
    ...
    parser.add_argument("--multimask", type=str2bool, default=False, help="output multimask")
    parser.add_argument("--encoder_adapter", type=str2bool, default=True, help="use UCS adapter")
    parser.add_argument("--prompt_path", type=str, default=None, help="fix prompt path")
    parser.add_argument("--save_pred", type=str2bool, default=False, help="save prediction masks")
    parser.add_argument("--resume", type=str, default=None)
    parser.add_argument("--use_rgb_eccentric", type=str2bool, default=True, help="use RGB eccentric adapter")
